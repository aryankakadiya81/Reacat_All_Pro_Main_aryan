...
const CardData = () => {
  ...
  const fetchData = async () => {
    await axios
      .get(
        `/api/products/productsget?category=${categoryId}&page=${page}&pagePerRecords=${pagePerRecords}&sortFieldKey=${sortFieldKey.sortFieldKey}&sortKey=${sortFieldKey.sortKey}&productName=${keyword}`
      )
      .then((data) => {
